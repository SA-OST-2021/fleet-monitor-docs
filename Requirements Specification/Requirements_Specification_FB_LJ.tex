...
\input{sections/glossary_acronyms}
\makeglossaries
...
%	\printglossaries
	...
	\input{sections/2_task_definition}
	\input{sections/3_product_requirements}
	\input{sections/4_use_cases}
	%\input{sections/5_global_requirements}
